  ...
  return (
    <group
     ...
     // onPointerMissed={() => (state.current = null)}
      // onPointerDown={e => {
      //   e.stopPropagation();
      //   // group.current.rotation.set(xRotation * Math.PI, yRotation * Math.PI,zRotation * Math.PI)
      //   const axis = [e.unprojectedPoint.x, e.unprojectedPoint.y, e.unprojectedPoint.z];
      //   const angle = Math.PI /2
      //   console.log(e)
      //   group.current.rotateX(angle)
