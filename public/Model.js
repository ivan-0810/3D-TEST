...
export default function Model({ ...props }) {
  ...
  useEffect(() => {
   ...
   actions['Cube_HD.002_cell.010Action'].play();
   actions['Cube_HD.002_cell.011Action'].play();
   actions['Cube_HD.002_cell.012Action'].play();
   actions['Cube_HD.002_cell.013Action'].play();
   actions['Cube_HD.002_cell.014Action'].play();
   actions['Cube_HD.002_cell.015Action'].play();
   actions['Cube_HD.002_cell.016Action'].play();
